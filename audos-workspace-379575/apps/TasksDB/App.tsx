        ...
        {loading ? (
          ...
          <>
            ...
            {tasks.map((task) => (
              <li
                key={task.id}
                className="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl border border-[var(--space-border-default)] bg-[var(--space-surface-card)] transition-colors hover:border-[color-mix(in_srgb,var(--space-brand-primary-500)_40%,transparent)]"
