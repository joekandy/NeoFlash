...
import type { BrandPaletteInput } from "@shared/brand-theme";
import type { SpaceMemberAccess } from "@shared/schema";
...
export interface AgentConfig {
  ...
  /** Per-turn narrowing hint; omitted/empty keeps the backend's full toolset. */
  toolScope?: string[];
}
