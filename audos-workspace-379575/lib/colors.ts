 ...
 * NeoFlash: primary #00c8ff, highlight #ff5a3c, contrast #2dff9e, Space Grotesk.
 * 
 * Color Philosophy:
...
export const surfaces = {
  page: 'var(--space-surface-page)',
  pageAlt: 'var(--space-surface-page-alt)',
  card: 'var(--space-surface-card)',
  cardHover: 'var(--space-surface-card-hover)',
  panel: 'var(--space-surface-panel)',
  muted: 'var(--space-surface-muted)',
  accentSoft: 'var(--space-surface-accent-soft)',
} as const;

export const shell = {
  shadow: 'var(--space-shell-shadow)',
  shadowStrong: 'var(--space-shell-shadow-strong)',
  icon: 'var(--space-shell-icon)',
} as const;
...
export const tw = {
  ...
  dock: {
    ...
    glass: 'bg-[var(--space-surface-panel)] backdrop-blur-lg rounded-2xl shadow-[0_22px_56px_var(--space-shell-shadow-strong)]',
  },
  ...
  card: {
    ...
    glass: 'bg-[var(--space-surface-panel)] backdrop-blur-md border border-[var(--space-border-default)] rounded-2xl shadow-[0_22px_56px_var(--space-shell-shadow-strong)]',
